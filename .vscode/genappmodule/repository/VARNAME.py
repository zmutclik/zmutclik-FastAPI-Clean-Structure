...
class CLASSNAMERepo:
    ...
    @abstractmethod
    async def get_VARNAME(self, VARNAME_id: int) -> Optional[CLASSNAME]:
        pass

    @abstractmethod
    async def get_VARNAME_by(self, VARNAME: str) -> Optional[CLASSNAME]:
        pass

    @abstractmethod
    async def save_VARNAME(self, VARNAME: CLASSNAME) -> CLASSNAME:
        pass

    @abstractmethod
    async def update_VARNAME(self, VARNAME: CLASSNAME, **kwargs) -> CLASSNAME:
        pass

    @abstractmethod
    async def delete_VARNAME(self, VARNAME: CLASSNAME, deleted_user: str) -> None:
        pass
