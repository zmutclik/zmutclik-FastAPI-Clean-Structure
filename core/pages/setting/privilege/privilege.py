...
@router.get("/{PathCheck}/menu/{menutype_id:int}/{privilege_id:int}", status_code=200, dependencies=page.depend_r())
async def page_settings_privilege_get_menus(privilege_id: int, menutype_id: int, req: page_req):
...
async def page_settings_privilege_js(req: page_req, pathFile: EnumJS, privilege_id: int = 0):
...
async def page_settings_privilege_datatables(params: dict[str, Any], req: page_req) -> dict[str, Any]:
...
async def page_settings_privilege_create(dataIn: PrivilegeRequest, req: page_req):
...
async def page_settings_privilege_update(privilege_id: int, dataIn: PrivilegeRequest, req: page_req):
...
async def page_settings_privilege_delete(privilege_id: int, req: page_req):
