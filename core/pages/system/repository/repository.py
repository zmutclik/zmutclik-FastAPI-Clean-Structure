...
async def page_system_repository_js(req: page_req, pathFile: EnumJS):
    return page.response(req, "/html/" + pathFile)


#######################################################################################################################
@router.post("/{PathCheck}/datatables", status_code=202, dependencies=page.depend_r())
async def page_system_repository_datatables(params: dict[str, Any], req: page_req) -> dict[str, Any]:
...
async def page_system_repository_create(dataIn: SysRepoRequest, req: page_req):
...
async def page_system_repository_update(repository_id: int, dataIn: SysRepoRequest, req: page_req):
...
async def page_system_repository_delete(repository_id: int, req: page_req):
