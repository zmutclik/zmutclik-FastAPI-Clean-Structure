...
from .request import MenuRequest, MenuTypeRequest
from .response import MenuResponse, MenusResponse, MenuTypeResponse
...
async def datatables_menutype(params: dict[str, Any], req: page_req) -> dict[str, Any]:
...
async def create_menutype(dataIn: MenuTypeRequest, req: page_req):
...
async def update_privilege(menutype_id: int, dataIn: MenuTypeRequest, req: page_req):
