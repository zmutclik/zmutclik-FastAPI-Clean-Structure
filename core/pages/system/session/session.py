...
from core.app.security.client.service import ClientService, ClientUserOTPService
...
@router.get("/{PathCheck}/otp.js", response_class=HTMLResponse, dependencies=page.depend_r())
async def page_system_session_js(req: page_req):
    return page.response(req, "/html/js/otp.js")
...
@router.post("/{PathCheck}/datatables/otp", status_code=202, dependencies=page.depend_r())
async def page_system_clientotp_datatables(params: dict[str, Any], req: page_req) -> dict[str, Any]:
    return await ClientUserOTPService().datatable_clientotp(params=params)
