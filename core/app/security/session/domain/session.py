...
class Session(Base):
    ...
    @classmethod
    def create(cls, client_id: str, session_id: str, user: str, session_end: datetime) -> "Session":
        return cls(client_id=client_id, session_id=session_id, user=user, session_end=session_end, session_start=datetime.now())
